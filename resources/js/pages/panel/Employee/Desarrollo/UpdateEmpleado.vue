<template>
    <Dialog v-model:visible="dialogVisible" header="Editar Empleado" modal :closable="true" :style="{ width: '90%', maxWidth: '650px' }">
    <div class="flex flex-col gap-6">
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-12 sm:col-span-6">
                ...
                <InputText v-model.trim="empleado.name" placeholder="Ingrese su nombre" maxlength="150" class="w-full" />
            ...
            <div class="col-span-12 sm:col-span-6">
                ...
                <InputText v-model.trim="empleado.apellido" placeholder="Ingrese su apellido" maxlength="150" class="w-full" />
            ...
            <div class="col-span-12 sm:col-span-6">
                ...
                <InputText v-model.trim="empleado.codigo" placeholder="Ingrese su código" maxlength="8" class="w-full" />
