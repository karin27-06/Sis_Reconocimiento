...
const selectedEstadoSchedule = ref(null);
const updateScheduleDialog = ref(false);
...
const estadoScheduleOptions = ref([
    { name: 'TODOS', value: '' },
...
function confirmDeleteSchedule(selected) {
...
const loadSchedules = async () => {
    ...
    try {
        ...
        const response = await axios.get('/horario', { params });
